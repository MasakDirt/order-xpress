...
public class UserExceptionHandler {
    ...
    @ExceptionHandler(HashingPasswordException.class)
    public ResponseEntity<ErrorResponse> handleHashingPasswordException(
            HttpServletRequest request, HashingPasswordException ex) {
